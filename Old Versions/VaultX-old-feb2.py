...
class MainApp(Frame):
	...
	def make_widgets(self, option_list, wallet_list):
		self.winfo_toplevel().title('VaultX (0.12 - Stable)')
		...
		copy = Button(option_frame, text='Copy Information', command=lambda: self.copy_function())
	...
	def gui_add_wallet(self):
		...
		wallet_add_window.winfo_toplevel().title('Add Wallet')
